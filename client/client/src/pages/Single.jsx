  ...
  return (
    <div className="single">
      <div className="content">
        ...
        <p>
          Kandive Blog is a website created by two students. This site allows one to share their personal experiences, ancedotes and stories.
           These can be about travel, life lessons, challenges you've overcome or any unique adventures. The themes covered here are Art, Science,
           Technology, Cinema, Design, Food and many more.
        </p>
      </div>
